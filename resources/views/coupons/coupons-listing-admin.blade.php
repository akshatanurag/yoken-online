        ...
        <tr>
            ...
            @foreach($coupons as $coupon)
                ...
                <tr>
                    ...
                    @if($coupon->target_type == 'CTG')
                    <td>A Category</td>
                    @elseif($coupon->target_type == 'INS')
                    <td>An Institute</td>
                    @elseif($coupon->target_type == 'CRS')
                    <td>A Course</td>
                    @elseif($coupon->target_type == 'USR')
                    <td>A User</td>
                    @else
                        <td>Everywhere</td>
                    @endif
                    ...
                    <td>
                        <form action="{{route('coupon.delete-admin', ['coupon'=> $coupon->id])}}" method="post">{{csrf_field()}}</form>
...
@section('footer')
    <div class="fixed-action-btn">
        <a class="btn-floating waves-effect btn-large" href="{{route('coupon.create-admin')}}">
