...
@section('main-content')
    ...
    <table class="striped">
            @foreach($faculties as $faculty)
                <tr>
                    ...
                    <td>
                        <a href="{{route('faculty.update', ['faculty' => $faculty->id])}}" class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="Edit"><i class="material-icons green-text text-lighten-2">mode_edit</i></a>
                    </td>
                    <td>
    ...
    @else
        <div class="card-panel"><span class="red-text text-lighten-1">You have not added any faculties yet.</span></div>
    @endif
